...
export default function LeFivePage() {
  ...
  if (phase === 'setup') {
    return (
      <div className="bg-[#0D1B14] min-h-[calc(100dvh-2rem)] overflow-x-hidden rounded-2xl p-6 md:p-8 text-[#E2E8F0] border-4 border-[#1E3A2B] shadow-2xl relative font-sans">
        {/* En-tête Tableau */}
  ...
  if (phase === 'formation_choice') {
    ...
    return (
      <div className="bg-[#0D1B14] min-h-[calc(100dvh-2rem)] overflow-x-hidden rounded-2xl p-4 md:p-6 text-[#E2E8F0] max-w-5xl mx-auto flex flex-col gap-6 border-4 border-[#1E3A2B] shadow-2xl">
        <div
  ...
  return (
    <div className="bg-[#0D1B14] min-h-[calc(100dvh-2rem)] overflow-x-hidden rounded-2xl p-4 md:p-6 text-[#E2E8F0] flex flex-col justify-between border-4 border-[#1E3A2B] shadow-2xl font-sans">
