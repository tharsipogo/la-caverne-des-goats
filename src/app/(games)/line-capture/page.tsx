...
const PLAYER_COLORS = [
  { hex: getPlayerColor(0).hex, label: 'Joueur 1' },
  { hex: getPlayerColor(1).hex, label: 'Joueur 2' },
];
...
export default function LineCapturePage() {
  ...
  if (phase === 'setup') {
    return (
      <GameConfigShell
        title="Line Capture"
        subtitle="Reliez les points pour capturer les cartes de la grille 3x3 et constituez votre équipe."
        onBack={() => router.push('/')}
      >
          <div>
          ...
          <div className="flex gap-6 flex-wrap">
            <div className="flex-1 min-w-[200px]">
              <label className="text-[12.5px] text-muted block mb-1.5">Joueur 1</label>
              <PlayerNameField index={0} value={names[0]} onChange={(v) => setNames([v, names[1]])} />
            </div>
            <div className="flex-1 min-w-[200px]">
              <label className="text-[12.5px] text-muted block mb-1.5">Joueur 2</label>
