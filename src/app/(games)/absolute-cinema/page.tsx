...
export default function AbsoluteCinemaPage() {
  ...
  if (phase === 'setup') {
    return (
      <div className="bg-[#0A0A0C] min-h-[calc(100dvh-2rem)] overflow-x-hidden rounded-2xl p-6 md:p-8 text-[#E0E0E0] border border-[#D4AF37]/30 shadow-2xl">
  ...
  if (phase === 'draft') {
    ...
    return (
      <div className="bg-[#0A0A0C] min-h-[calc(100dvh-2rem)] overflow-x-hidden rounded-2xl p-4 md:p-6 text-[#E0E0E0] max-w-5xl mx-auto flex flex-col gap-6 border border-[#D4AF37]/30 shadow-2xl">
        <div
  ...
  return (
    <div className="bg-[#0A0A0C] min-h-[calc(100dvh-2rem)] overflow-x-hidden rounded-2xl p-4 md:p-6 text-[#E0E0E0] flex flex-col justify-between border border-[#D4AF37]/30 shadow-2xl">
