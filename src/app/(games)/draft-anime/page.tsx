...
export default function AnimeDraftPage() {
  ...
  if (phase === 'setup') {
    return (
      <div className="bg-[#0B0F19] min-h-[calc(100dvh-2rem)] mb-20 md:mb-0 rounded-2xl p-4 md:p-8 text-[#E2E8F0] border border-white/10 shadow-2xl relative font-sans">
  ...
  if (phase === 'draft') {
    ...
    return (
      <div
        className={`min-h-[calc(100dvh-2rem)] mb-20 md:mb-0 rounded-2xl p-4 md:p-6 text-[#E2E8F0] max-w-6xl mx-auto flex flex-col gap-6 border-2 shadow-2xl ${
  ...
  return (
    <div
      className={`min-h-[calc(100dvh-2rem)] mb-20 md:mb-0 rounded-2xl p-4 md:p-6 text-[#E2E8F0] flex flex-col justify-between border-2 shadow-2xl ${
        isNaruto ? 'bg-[#120B05] border-[#FF6600]/40' : 'bg-[#05101A] border-[#00B4D8]/40'
      }`}
    >
